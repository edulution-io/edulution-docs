...
| **Benachrichtigungen** | Glockensymbol mit Zähler ungelesener [Benachrichtigungen](../apps/benachrichtigungen.md) |
...
| **[Wiki](../apps/wiki.md)** | Der Baumansicht aller Wikis und Seiten | `Enter` öffnet zusätzlich die Volltextsuche über alle Inhalte |
...
Auf schmalen Bildschirmen und in der [mobilen App](../apps/mobile-app.md) sind beide Leisten eingeklappt. Stattdessen erscheint oben eine schmale Leiste mit je einer Schaltfläche:
...
- [Benachrichtigungen](../apps/benachrichtigungen.md) – Benachrichtigungsbereich hinter dem Glockensymbol
