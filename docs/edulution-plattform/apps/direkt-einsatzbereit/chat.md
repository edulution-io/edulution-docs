...
Der Messenger überträgt Text und Emojis. Datei- oder Bildanhänge sind im Chat nicht vorgesehen – nutzen Sie dafür die [Dateiverwaltung](../mit-einrichtung/dateien/index.md).
:::
...
- [Konferenzen](../mit-einrichtung/konferenzen.md) – Audio- und Videokonferenzen
