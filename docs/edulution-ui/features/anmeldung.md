...
Die Fußzeile enthält die Versionsnummer der Oberfläche und – sofern eingerichtet – die Links zu **Impressum** und **Datenschutz** (siehe [Impressum und Datenschutz einrichten](impressum-datenschutz.md)).
...
2. Scannen Sie den QR-Code mit der [edulution.io App](mobile-app.md).
...
Einrichtung und unterstützte Apps sind unter [Sicherheit & Authentifizierung](sicherheit.md#zwei-faktor-authentifizierung-2fa) beschrieben.
...
- [Einstellungen (Settings)](../administration/einstellungen.md) – Branding und Organisationsinformationen pflegen
- [Impressum und Datenschutz einrichten](impressum-datenschutz.md) – Links in der Fußzeile
- [Sicherheit & Authentifizierung](sicherheit.md) – Zwei-Faktor-Authentisierung und Passwörter
- [Mobile App](mobile-app.md) – edulution.io App für den QR-Login
