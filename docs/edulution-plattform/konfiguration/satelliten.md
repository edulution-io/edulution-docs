...
Diese Seite beschreibt den **laufenden Betrieb** in der edulution Plattform. Die Erstinbetriebnahme eines Geräts – Apps installieren, WireGuard starten, Gerät koppeln und zentrale Netze bereitstellen – ist unter [edulution Satellite](../apps/satellite/index.md) beschrieben.
:::
