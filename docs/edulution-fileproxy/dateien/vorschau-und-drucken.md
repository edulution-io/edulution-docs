...
Office-Dokumente setzen voraus, dass Ihr Administrator einen [Dokumenten-Editor eingerichtet hat](./konfiguration/dokumenten-editor.md) – OnlyOffice, Collabora Online oder EuroOffice. Ist keiner konfiguriert, lässt sich ein Office-Dokument nicht öffnen; PDF-Dateien öffnen sich unabhängig davon.
...
- **Markdown-Dateien** werden formatiert dargestellt – Überschriften, Listen, Tabellen, Zitate und Links erscheinen so, wie sie gemeint sind. Welche Formatierungen möglich sind, zeigt die [Markdown-Hilfe](../../edulution-plattform/apps/native-apps/markdown-hilfe.md)
...
- [Markdown-Hilfe](../../edulution-plattform/apps/native-apps/markdown-hilfe.md) – unterstützte Formatierungen
