...
Fehlt die Schaltfläche, prüfen Sie, ob unter **Einstellungen → Desktop-Bereitstellung** eine URL hinterlegt ist und ob der Guacamole-Container läuft – siehe [Desktop-Bereitstellung (VDI)](../features/desktop-bereitstellung.md#einrichtung-für-administratoren).
