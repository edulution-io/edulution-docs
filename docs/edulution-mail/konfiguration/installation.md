...
Statt die Konfiguration einzufügen, können Sie im Abschnitt **Proxy-Konfiguration** auch **Vorlage** wählen – sie enthält genau die gezeigte Konfiguration. edulution hält diese Route anschließend selbstständig aktuell; siehe [Automatischer Abgleich](../../edulution-plattform/konfiguration/einstellungen.md#automatischer-abgleich).
:::
