...
- [Einstellungen](../../konfiguration/einstellungen.md) – App-Konfiguration durch den Global-Admin
- [App-Store & Anwendungen](../direkt-einsatzbereit/app-store.md) – Apps installieren und verwalten
