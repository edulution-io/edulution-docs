...
Eine fehlerhafte Konfiguration kann dazu führen, dass die Wiki-Suche nicht mehr erreichbar ist. Die serverseitige Einrichtung von FileProxy und Suchindex ist in der [Wiki-Infrastruktur](../../edulution-fileproxy/konfiguration/wiki-infrastruktur.md) beschrieben.
...
- [Wiki-Infrastruktur](../../edulution-fileproxy/konfiguration/wiki-infrastruktur.md) – FileProxy- und Elasticsearch-Setup für die Wiki-Suche
