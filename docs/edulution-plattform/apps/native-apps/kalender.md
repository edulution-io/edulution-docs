...
Auch ein Link auf einen **bestimmten Termin** wirkt im Stundenplan: Er stellt die Woche ein, in der die Stunde liegt, und öffnet sie – sofern sie zum geöffneten Stundenplan gehört. Verweist der Link auf einen Termin aus einem anderen Kalender, geschieht nichts; der Stundenplan bleibt auf der verlinkten Woche stehen.

Eine über einen Link vorgegebene **Kalenderauswahl** übersteht den Wechsel zwischen Stundenplan und Kalenderansicht in beide Richtungen. Im Stundenplan schränkt sie die angezeigten Termine nicht ein – dort sehen Sie ohnehin nur den geöffneten Stundenplan –, die Seitenleiste zeigt aber weiterhin die Auswahl des Links, und über **Zurück** kehren Sie mit dieser Auswahl in die Kalenderansicht zurück.
...
Ist der geöffnete Stundenplan nicht mehr vorhanden – etwa weil der Kalender gelöscht oder seine Stundenplan-Markierung entfernt wurde –, wechselt die Ansicht selbsttätig zurück zur Kalenderübersicht. Sind Sie über einen Link gekommen, bleiben dessen Ansicht, Zeitraum und Kalenderauswahl dabei erhalten. Lässt sich die Kalenderliste dagegen gar nicht laden, etwa weil der CalDAV-Server nicht erreichbar ist, bleiben Sie auf der Stundenplan-Ansicht und es erscheint der Hinweis **Stundenpläne konnten nicht geladen werden.** Ein Ladefehler wird also nicht als gelöschter Stundenplan behandelt; sobald die Verbindung wieder steht, genügt **Neu laden**.
...
1. **Kalender** – Der Kalender, in dem der Termin gespeichert wird. Zur Auswahl stehen nur Kalender, in die Sie schreiben dürfen. Vorausgewählt ist der über das [Kalenderkontextmenü](#kalenderkontextmenü) als Standard festgelegte Kalender, andernfalls der erste beschreibbare Kalender. Ein gerade ausgeblendeter Kalender wird dabei übergangen – auch einer, den die [Kalenderauswahl eines Links](#ansicht-merken-verlinken-und-zurückblättern) ausblendet –, damit ein neuer Termin nicht in einem Kalender landet, den Sie gerade nicht sehen.
