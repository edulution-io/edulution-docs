...
Stellen Sie sicher, dass alle [Voraussetzungen](/docs/edulution-plattform/apps/mit-einrichtung/lernmanagement/installation/voraussetzungen) erfüllt sind.
:::
...
- [Detaillierte Installation](/docs/edulution-plattform/apps/mit-einrichtung/lernmanagement/installation/detailliert) - Erweiterte Optionen
- [Konfiguration](/docs/edulution-plattform/apps/mit-einrichtung/lernmanagement/konfiguration/umgebungsvariablen) - Alle Einstellungen
- [Synchronisation](/docs/edulution-plattform/apps/mit-einrichtung/lernmanagement/konfiguration/synchronisation) - Sync-Details
