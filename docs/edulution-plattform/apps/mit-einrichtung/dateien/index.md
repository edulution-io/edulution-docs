...
Siehe auch [Mobile App & Tablet-Nutzung](../../direkt-einsatzbereit/mobile-app.md).
...
- [Mobile App](../../direkt-einsatzbereit/mobile-app.md) - Dateien mobil synchronisieren
- [Eingebettete App](../../direkt-einsatzbereit/eingebettete-app.md) - HTML/JS/CSS hochladen
