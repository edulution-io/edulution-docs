...
- [Package Server](./package-server.md) eingerichtet
...
Siehe [Wiki-Infrastruktur](./wiki-infrastruktur.md) für die vollständige Einrichtung von ES-Sidecar und Erstindex.
...
Anschließend gemäß [Wiki-Infrastruktur](./wiki-infrastruktur.md) den Elasticsearch-Sidecar starten und den ersten Index-Lauf durchführen.
...
Richten Sie den [FileProxy in der UI](./ui-config.md) ein →
