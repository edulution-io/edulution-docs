## v1.6.0 | 2025-10-28 | edulution-plattform
...
- **Öffentliche Seiten**: Neu können öffentliche Seiten konfiguriert werden. Nützlich für z.B. Impressum und Datenschutzerklärung ([→ Anleitung](/docs/edulution-plattform/features/impressum-datenschutz))
...
- Dateien: Fehler beim Hochladen bestimmter Dateitypen behoben. Anzeige von Dateien mit speziellen Zeichen repariert
- Mobile-Setup Link funktioniert wieder.
- Erstellen eines Dokuments führte zu einer fehlerhaften Datei wurde behoben.
- Ordner hochladen ist in dieser Version deaktiviert

#### Verbesserungen

- Linuxmuster-Webdav: Upload-Größe auf 50MB beschränkt. [tags: school]
