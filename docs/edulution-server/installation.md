...
1\. Um die edulution Plattform zu verwenden, ist die Installation der
...
Einstellungen\" -\> \"edulution Plattform\"
...
edulution Plattform den Linuxmuster-Server erreichen kann. Im Standard wird
