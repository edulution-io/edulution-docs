...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
  <a href="/docs/edulution-plattform/apps/mit-einrichtung/lernmanagement/konfiguration/namensschemas" className="card">
    <h3>Gruppen-Namensschemas</h3>
    <p>So benennen Sie Keycloak-Gruppen richtig</p>
  </a>
  <a href="/docs/edulution-plattform/apps/mit-einrichtung/lernmanagement/konfiguration/synchronisation" className="card">
...
Wie Moodle als App **Lernmanagement** in edulution eingebunden wird und wie die Anmeldung ohne zweiten Login abläuft, beschreibt [Lernmanagement (Moodle)](/docs/edulution-plattform/apps/mit-einrichtung/lernmanagement/).
:::
