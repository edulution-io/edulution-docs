## v1.1.0 | 2025-03-05 | edulution-plattform
...
- **App Store & Container-Management** — Apps als Container installierbar: Mailcow, OnlyOffice, Guacamole, Veyon-WebAPI ([→ App-Store Dokumentation](/docs/edulution-plattform/features/app-store))
