...
- [Einstellungen](einstellungen.md) – globale Konfiguration, u.a. der Zielplattform
- [Linuxmuster verbinden](../configure-lmn-server/configure_lmn-server.md) – Verbindung zum Schulserver einrichten
