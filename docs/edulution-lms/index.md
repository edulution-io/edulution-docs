---
title: edulution LMS
description: Lernmanagement mit Moodle – ohne zweiten Login, Kurse automatisch aus Ihren Gruppen
---
...
Wie bei jeder App legen Sie unter **Einstellungen** → **Lernmanagement** fest, wo die App erscheint (Seitenleiste, Menüleiste, App-Launcher) und welche Nutzergruppen sie sehen. Details dazu unter [Einstellungen](../edulution-plattform/konfiguration/einstellungen.md).
...
- [App-Store & Anwendungen](../edulution-plattform/apps/native-apps/app-store.md) – Apps hinzufügen und verwalten
