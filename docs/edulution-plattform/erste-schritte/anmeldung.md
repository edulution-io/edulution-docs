...
Die Fußzeile enthält die Versionsnummer der Oberfläche und – sofern eingerichtet – die Links zu **Impressum** und **Datenschutz** (siehe [Impressum und Datenschutz einrichten](../apps/impressum-datenschutz.md)).
...
2. Scannen Sie den QR-Code mit der [edulution.io App](../apps/mobile-app.md).
...
Einrichtung und unterstützte Apps sind unter [Sicherheit & Authentifizierung](../apps/sicherheit.md#zwei-faktor-authentifizierung-2fa) beschrieben.
...
- [Impressum und Datenschutz einrichten](../apps/impressum-datenschutz.md) – Links in der Fußzeile
- [Sicherheit & Authentifizierung](../apps/sicherheit.md) – Zwei-Faktor-Authentisierung und Passwörter
- [Mobile App](../apps/mobile-app.md) – edulution.io App für den QR-Login
