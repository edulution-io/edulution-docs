...
Diese Seite beschreibt, was dafür in Keycloak und – für den Rückfallweg – auf dem Linuxmuster-Server eingerichtet sein muss. Die Bedienung aus Benutzersicht ist unter [Benutzereinstellungen → Sicherheit](../benutzer/mein-profil.md#passwort-ändern) beschrieben.
...
- Bind-User und Edulution-Setup-Token sind eingerichtet – siehe [Anpassung am Linuxmuster-Server](../configure-lmn-server/configure_lmn-server.md).
...
- [Benutzereinstellungen → Sicherheit](../benutzer/mein-profil.md#sicherheit) – Passwortänderung aus Benutzersicht
...
- [Anpassung am Linuxmuster-Server](../configure-lmn-server/configure_lmn-server.md) – Linuxmuster-API und Setup-Token
