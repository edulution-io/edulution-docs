...
| **Benachrichtigungen** | Glockensymbol mit Zähler ungelesener [Benachrichtigungen](benachrichtigungen.md) |
...
Welche Apps dauerhaft in der App-Leiste stehen, legt der Global-Admin je App über die Einstellung **An App-Leiste anpinnen** fest (siehe [Einstellungen](../administration/einstellungen.md)). Ist sie aktiviert, bleibt die App dauerhaft sichtbar. Ist sie deaktiviert, erscheint die App dort nur, solange sie geöffnet ist.
...
| **[Wiki](wiki.md)** | Der Baumansicht aller Wikis und Seiten | `Enter` öffnet zusätzlich die Volltextsuche über alle Inhalte |

### Fußbereich

Einige Apps blenden unterhalb der Menüeinträge einen festen Fußbereich ein:

- **[Dateien](dateien/index.md)**: Zugangsdaten für [WebDAV](dateien/webdav-windows.md) sowie die Anzeige des belegten Speicherplatzes
- **[Kontakte](kontakte.md)**: Schaltfläche zum Anlegen eines neuen Adressbuchs
- **[E-Mail](e-mail.md)**: Hinweis, solange die Ordnerliste noch geladen wird

## Bedienung auf Tablet und Smartphone

Auf schmalen Bildschirmen und in der [mobilen App](mobile-app.md) sind beide Leisten eingeklappt. Stattdessen erscheint oben eine schmale Leiste mit je einer Schaltfläche:
...
- [Benachrichtigungen](benachrichtigungen.md) – Benachrichtigungsbereich hinter dem Glockensymbol
- [Mein Profil](../benutzer/mein-profil.md) – Einträge des Benutzermenüs
- [Einstellungen](../administration/einstellungen.md) – Apps anpinnen und Nutzergruppen freischalten
