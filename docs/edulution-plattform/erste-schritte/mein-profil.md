...
Weitere Details unter [Sicherheit & Authentifizierung](../apps/native-apps/sicherheit.md#passwort-tresor).
...
:::info[Voraussetzung]
Die Übertragung setzt voraus, dass als Mailsystem SOGo eingerichtet ist und Ihrem Konto eine E-Mail-Adresse zugeordnet ist. Die Verbindung zum Mailsystem legt die Administration unter [Einstellungen → E-Mails](../konfiguration/einstellungen.md#e-mails) fest.
:::
...
Weitere Details unter [Mobile App & Tablet-Nutzung](../../edulution-app/mobile-ansicht.md).
...
- [Sicherheit & Authentifizierung](../apps/native-apps/sicherheit.md) - Detaillierte Sicherheitseinstellungen
- [Mobile App](../../edulution-app/mobile-ansicht.md) - Mobile Nutzung
- [E-Mail Migration](../../edulution-mail/migration.md) - E-Mail einrichten
