...
- **Integrierter Passwort-Manager** — verschlüsselt, PIN zur Entschlüsselung ([→ Sicherheits-Features](/docs/edulution-plattform/features/sicherheit))
- **Eigene Apps erstellen und gestalten** — Editor oder HTML-Upload ([→ App-Store Dokumentation](/docs/edulution-plattform/features/app-store))
- **Force-MFA** — verpflichtende Zwei-Faktor-Authentifizierung für Gruppen ([→ Sicherheits-Features](/docs/edulution-plattform/features/sicherheit))
