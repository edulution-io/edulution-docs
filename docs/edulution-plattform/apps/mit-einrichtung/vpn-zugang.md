...
Der VPN-Zugang wird als native **WireGuard**-App über den [App-Store](../direkt-einsatzbereit/app-store.md) hinzugefügt und anschließend unter **Einstellungen** konfiguriert.
