...
Anhänge liegen als echte Dateien auf der WebDAV-Freigabe des Wikis, nicht in der Markdown-Datei selbst. Damit bleiben sie über die App [Dateien](../mit-einrichtung/dateien/index.md) erreichbar und lassen sich dort ansehen, [in der Dateivorschau öffnen](../mit-einrichtung/dateien/vorschau-und-drucken.md#vorschau-öffnen), herunterladen, umbenennen oder ersetzen.
...
- **Vorschau** – öffnet die Datei in einem Fenster innerhalb von edulution (dieselbe [Dateivorschau](../mit-einrichtung/dateien/vorschau-und-drucken.md#vorschau-öffnen) wie in der App **Dateien**)
...
- [Dateien](../mit-einrichtung/dateien/index.md) – Freigabe, auf der Wiki-Seiten und Anhänge gespeichert werden; dort lassen sich Dateien auch [ansehen und bearbeiten](../mit-einrichtung/dateien/vorschau-und-drucken.md#vorschau-öffnen)
