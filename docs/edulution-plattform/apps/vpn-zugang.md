...
Der VPN-Zugang wird als native **WireGuard**-App über den [App-Store](./native-apps/app-store.md) hinzugefügt und anschließend unter **Einstellungen** konfiguriert.
