...
- **Markdown-Dateien** werden formatiert dargestellt – Überschriften, Listen, Tabellen, Zitate und Links erscheinen so, wie sie gemeint sind. Welche Formatierungen möglich sind, zeigt die [Markdown-Hilfe](../../edulution-plattform/features/markdown-hilfe.md)
...
- [Markdown-Hilfe](../../edulution-plattform/features/markdown-hilfe.md) – unterstützte Formatierungen
