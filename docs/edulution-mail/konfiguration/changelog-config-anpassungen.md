...
Die übrigen Werte sind in der [Installations-Anleitung, Schritt 5](./installation.md#schritt-5-mailserver-hosts-konfigurieren) beschrieben.
...
Alles Übrige — `strip-sogo-mail-prefix`, `sogo-buffers` und der Service `edulution-sogo` — bleibt wie bisher. Die vollständige Konfiguration zum Übernehmen finden Sie in der [Installations-Anleitung, Schritt 3](./installation.md#schritt-3-proxy-konfiguration-hinzufügen).
...
Die finale dyn. Mail-Konfiguration (ohne `tcp:`-Block) finden Sie in der [Installations-Anleitung, Schritt 3](./installation.md#schritt-3-proxy-konfiguration-hinzufügen) — sie kann 1:1 in den Expertenmodus übernommen werden.
