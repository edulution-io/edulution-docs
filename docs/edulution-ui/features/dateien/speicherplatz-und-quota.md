...
Dieselben Werte finden Sie zusammen mit der berechneten Cloud- und E-Mail-Quota im [Dashboard](../dashboard.md#quotas).
...
- [Dashboard](../dashboard.md#quotas) – Speichernutzung inklusive Cloud- und E-Mail-Quota
