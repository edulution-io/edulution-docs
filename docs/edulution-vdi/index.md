...
Eine laufende Sitzung hindert Sie nicht daran, die übrigen edulution-Apps zu benutzen. Wechseln Sie in eine andere App, legt die Plattform das Sitzungsfenster selbsttätig als Leiste ab. Die Verbindung zum virtuellen Desktop bleibt dabei bestehen – was dort läuft, läuft weiter, und der Client bleibt Ihnen vorbehalten.

Kehren Sie zur **Desktop-Bereitstellung** zurück, öffnet sich das Fenster wieder. Ob die Plattform es dabei zurückholt oder Sie es über **Maximieren** bzw. **Wiederherstellen** in der Leiste öffnen – es erscheint jeweils in der Größe und an der Position, in der Sie es verlassen haben.

:::note[Eine selbst minimierte Sitzung bleibt liegen]
Haben Sie das Fenster von Hand über **Minimieren** in die Leiste gelegt, bleibt es auch beim Zurückwechseln zur App dort – die Plattform holt nur die Fenster zurück, die sie beim Verlassen der Seite selbst weggelegt hat. Über die Leiste öffnen Sie die Sitzung jederzeit wieder.
:::
