...
Eigene Änderungen überschreibt der Abgleich, sobald eine neue Fassung mitgeliefert wird. Eine Route, die Sie von Hand eingetragen statt über **Vorlage** übernommen haben, ersetzt bereits der nächste Start durch die mitgelieferte Fassung – das betrifft auch jede bestehende Installation beim ersten Start nach dem Update. Notieren Sie sich deshalb Anpassungen, auf die Ihre Installation angewiesen ist, und rufen Sie nach einem Update die betroffenen Apps einmal auf, um zu prüfen, ob sie noch erreichbar sind.
