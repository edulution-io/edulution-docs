...
In der App bietet jede Zeile der [Dateiverwaltung](../mit-einrichtung/dateien/index.md) zusätzlich die Aktion **In App öffnen**. Damit übergibt die Plattform die Datei an die App, die sie mit den Mitteln des Betriebssystems anzeigt – unter iOS über die Dateien-App. Im Browser entfällt die Aktion.
